...
export const books: Book[] = [
  ...
  },
  {
    ...
    pdfUrl: 'https://rjiozcbtszmyehzffzpa.supabase.co/storage/v1/object/public/pdfbook//EyedaneHede.pdf',
    publishedYear: 2020,
    rating: 4.6,
    totalRatings: 1543,
    chapters: [
...
መድብሏ በውስጧ ሰባት አጫጭር ታሪኮችን አካትታለች። የእንጎቻ ታሪክ እንደሚሉቱ አጠር ተደርገው በየራሳቸው ታሪክ ጀምረው ጨርሰዋል። በሀገር ውስጥም ሆነ ከኢትዩጵያ ውጪ ከተኖረ ህይወት ተጨልፈው በአንደኛና ሁለተኛ መደብ የተተረኩ ስለሆኑ በሁለቱም ቦታ የሚኖር ተደራሲ ቢያነባቸው ለስሜት ቅርብ ናቸው። በመሆኑም ለናንተም ለእኛም ተፅፈዋልና አይወክሉንም አይባልም።`,
    ...
    pdfUrl: 'https://rjiozcbtszmyehzffzpa.supabase.co/storage/v1/object/public/pdfbook//AwoEsuga.pdf',
    publishedYear: 2024,
    rating: 4.6,
    totalRatings: 377,
    chapters: [
